...
/******/ 			var chunk = require("./" + ({}[chunkId]||chunkId) + ".chunk." + {"0":"fe0d6","1":"6dbd2","2":"549ce"}[chunkId] + ".js");
...
/* harmony default export */ var icons = ([GitHub, Instagram, CodePen, CodeWars, Twitter]);
...
var Post_Post = function (_Component) {
  ...
  Post.prototype.getPostBody = function getPostBody(id) {
      ...
      button = Object(preact_min["h"])(
        'button',
        {
          ...
          onClick: function onClick() {
            return _this2.getPostBody(_this2.props.id);
          },
